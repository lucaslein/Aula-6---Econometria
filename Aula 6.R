...
TesteJB13 <- Box.test(ARMA13$residuals,lag = 3, type = "Ljung") #Retorna os residuas da regressão
TesteJB13 
...
#H0: não há autocorrelação adicional
#t-3 -> defasage ótima. 

MA4 <- arima(Inflacao,order = c(0,0,4))
TesteJB4 <- Box.test(MA4$residuals,lag = 3, type = "Ljung")
TesteJB4
